...
function resolveInitialValues(options, context) {
  ...
  return sources.reduce((acc, variant) => {
    return {
      ...acc,
      ...resolveVariant2(options[variant] || context?.[variant], options.variants, custom)
    };
  }, {});
}
...
var AnimationFeature = class extends Feature2 {
  ...
  constructor(state) {
    ...
    ve.animationState ||= createAnimationState2(ve);
  }
...
var InViewGesture = class extends Feature2 {
...
var ProjectionFeature = class extends Feature2 {
...
var LayoutFeature = class extends Feature2 {
...
var Item_vue_vue_type_script_setup_true_lang_default = defineComponent({
  ...
  setup(__props) {
    ...
    const point2 = {
      x: useDefaultMotionValue(style2.value?.x),
      y: useDefaultMotionValue(style2.value?.y)
    };

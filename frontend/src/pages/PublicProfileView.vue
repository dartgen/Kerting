            ...
            <div v-if="profilAdatok.ertekeles > 0" class="flex items-center justify-center gap-2 mt-2 sm:mt-0 sm:absolute sm:bottom-8 sm:left-1/2 sm:-translate-x-1/2 w-full sm:w-auto z-10">
              ...
              <div class="flex items-center text-yellow-400 drop-shadow gap-0.5">
                <template v-for="i in 5" :key="i">
                  ...
                  <svg v-else-if="profilAdatok.ertekeles >= i - 0.5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-5 h-5">
                    <path
                      stroke="currentColor"
                      stroke-width="1.5"
                      fill="none"
                    ...
                    <path
                      fill="currentColor"
                      d="M12 15.4V2l-2.81 6.63L2 9.24l5.46 4.73L5.82 21 12 17.27z"
                    />
                  </svg>
...
// Biztonságos URL formázó: hozzáadja a https:// előtagot, ha az lemaradt volna
